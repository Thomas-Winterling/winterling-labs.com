...
function Impressum() {
    ...
    <div className="impressum" style={{paddingTop: '100px'}}>
        ...
        <p>
            ...
            <p>Bezirkshauptmannschaft Musterhausen</p> <br />
            <strong>Webseite der Aufsichtsbehörde</strong> <br />
            <a href="https://www.aufsichtsbeoerde-musterhausen.de/" target>https://www.aufsichtsbeoerde-musterhausen.de/</a> <br />
